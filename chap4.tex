...
Many of the machine learning tools, such as \emph{MATLAB Statistics and Machine Learning Toolbox} or \emph{Tensorflow}, have default settings and are easy to use for beginners. 
...
Introducing the dual form of the optimization problem, use of kernels (which allows to work efficiently in higher dimensional spaces) is eased.
