...
where $\bm{\beta}$ is the bias, and $\bm{\eta}$ is the zero mean Gaussian process with $\bm{\sigma}^2$ variance and given in Table ~\ref{arm:sensorSpecs}.
